...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <h1 class="sr-only">Pengaturan Autentikasi Dua Faktor</h1>
            ...
            <div class="space-y-6">
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        ...
                        dimintai pin aman saat login. Pin ini dapat diambil dari
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        Dengan autentikasi dua faktor aktif, Anda akan dimintai
                        pin acak yang aman saat login, yang dapat Anda ambil
