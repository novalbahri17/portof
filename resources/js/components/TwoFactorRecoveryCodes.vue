    ...
    <Card class="w-full">
        <CardHeader>
            ...
            <CardDescription>
                ...
                perangkat 2FA Anda hilang. Simpan di pengelola kata sandi yang aman.
            </CardDescription>
        </CardHeader>
        <CardContent>
            <div
            ...
            >
                ...
                <div v-else class="mt-3 space-y-3">
                    ...
                    <p class="text-xs text-muted-foreground select-none">
                        ...
                        mengakses akun Anda dan akan dihapus setelah digunakan.
                        Jika Anda membutuhkan lebih banyak, klik
